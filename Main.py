...
'''
def openfileEnc():
	filename = tkFileDialog.askopenfilename(initialdir = "/home/Desktop",title = "Select file",filetypes = (("text files","*.txt"),("all files","*.*")))
	fileToEncrptyEntryUpdate(filename)

def opendirectoryEnc():
	directory = tkFileDialog.askdirectory(initialdir = "/home/Desktop",title = "Select directory")
